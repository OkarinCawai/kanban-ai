...
NEVER use generic AI-generated aesthetics: overused font families (Inter, Roboto, Arial, system fonts), cliched color schemes (e.g. purple gradients on white), predictable layouts and component patterns, and cookie-cutter design that lacks context-specific character.
...
Remember: commit fully to a distinctive vision and show what can be created when thinking outside the box.
